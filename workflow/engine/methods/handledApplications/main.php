...
$G_ID_MENU_SELECTED = 'HANDLED_APPLICATIONS';

$_SESSION['G_CASE_DEFAULT_OPTION'] = 'casesListExtJs?action=sent';
$_SESSION['G_CASE_CONF_DEFAULT_OPTION'] = 'CASES_SENT';
$_SESSION['DEFAULT_CASES_FILTER'] = 'completed';
...
$oHeadPublisher->assign('hideLeftMenu', 'true');
